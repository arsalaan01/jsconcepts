...
console.log(new Date('May 16 2021 14:26:55'));
...
// const days1 = Math.abs(
//   new Date(2037, 3, 4).getDate() - new Date(2037, 3, 14).getDate()
// );
console.log(days1);
